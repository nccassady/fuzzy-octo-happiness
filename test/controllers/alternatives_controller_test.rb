...
class AlternativesControllerTest < ActionController::TestCase
  ...
  test "should create alternative" do
    assert_difference('Alternative.count') do
      post :create, alternative: { company_id: @alternative.company_id, description: @alternative.description, name: @alternative.name }
    end
  ...
  test "should update alternative" do
    patch :update, id: @alternative, alternative: { company_id: @alternative.company_id, description: @alternative.description, name: @alternative.name }
    assert_redirected_to alternative_path(assigns(:alternative))
  end
